...
console.log("\nIs your name 'Tayyaba'?");
console.log(yourName == 'Tayyaba');
// answer will be true 
...
console.log("\nIs your first name really 'Tayyaba'?");
console.log(yourName !== yourName.toLowerCase());
